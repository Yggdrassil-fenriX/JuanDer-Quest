const WalletAction = (props) => {
    ...
    const onClickMethod = props.onClick || (() => { console.log(actionName); });

    return (
        <button className="flex w-[23%] flex-col items-center justify-center rounded-md bg-white p-3 shadow-[0px_0px_10px_rgba(0,0,0,0.5)]" onClick={onClickMethod}>
            ...
            <p className="mt-3 font-medium text-xs text-[#3d3d3d]">
                {actionName}
            </p>
        </button>
    );
